...
int main(int argc, char* argv[]) {
    ...
    // inicializa o mutex
    pthread_mutex_init(&matrix_mutex, NULL); // inicializa o mutex - argumento: endereço do mutex, NULL para atributos padrão
    //Crias as threads
    ...
    //Destrói o mutex
    pthread_mutex_destroy(&matrix_mutex); // destrói o mutex - argumento: endereço do mutex)
